...
const (
	...
	DescriptionCollectionMember              = "Member of a collection."
	DescriptionCollectionMemberUserEmail     = "User email."
	DescriptionCollectionMemberOrgMemberId   = "Organization User ID."
	DescriptionCollectionMemberReadOnly      = "Read/Write permissions."
	DescriptionCollectionMemberHidePasswords = "Hide passwords."
