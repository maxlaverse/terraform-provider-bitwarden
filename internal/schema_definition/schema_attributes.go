...
const (
	...
	AttributeLoginPasswordWO               = "password_wo"
	AttributeLoginWOVersion                = "wo_version"
	AttributeLoginUsername                 = "username"
	AttributeLoginUsernameWO               = "username_wo"
	...
	DescriptionLoginPasswordWO               = "Login password (write-only). Not stored in state. Requires `wo_version` to be set, and bumped whenever `password_wo` or `username_wo` changes, so Terraform can detect an update. Conflicts with `password`."
	DescriptionLoginWOVersion                = "Used together with `password_wo` and `username_wo` to trigger an update: change this value whenever either changes."
	...
	DescriptionLoginUsernameWO               = "Login username (write-only). Not stored in state. Requires `wo_version` to be set, and bumped whenever `password_wo` or `username_wo` changes, so Terraform can detect an update. Conflicts with `username`."
