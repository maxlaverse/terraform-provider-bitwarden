...
const (
	...
	attributeItemAttachmentItemID   = "item_id"
	attributeItemAttachmentFile     = "file"
	attributeItemAttachmentFileName = "file_name"
	...
	descriptionItemAttachmentFile = "File to upload as an attachment for a given item."
