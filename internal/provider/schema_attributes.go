...
const (
	...
	attributeFilterCollectionId   = "collection_id"
	attributeFilterFolderID       = "folder_id"
	attributeFilterOrganizationID = "organization_id"
	attributeFilterURL            = "url"
	...
	descriptionFilterSearch           = "Occurence to search for."
	descriptionFilterURL              = "URL to filter results by."
